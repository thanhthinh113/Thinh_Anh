    ...
    return (
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.container}>
          ...
          <TouchableOpacity style={[styles.button, styles.margin]} onPress={()=>navigation.navigate("Page06")}>
          ...
          <TouchableOpacity style={styles.login} onPress={()=>navigation.navigate("Page02")}>
