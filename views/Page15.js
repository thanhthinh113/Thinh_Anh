            ...
            <View style={styles.container}>
                ...
                <View style={styles.tabContainer1} >
                    ...
                    <View style={styles.content}>
                        ...
                        <Text style={styles.message}>When you contact a host or send a</Text>
                        <Text style={styles.message}>reservation request, you'll see your</Text>
                        <Text style={styles.message}>messages here.</Text>
                    </View>
                </View>
            </View>
